  ...
  return (
    <View style = {{display : 'flex', flexDirection : 'column', justifyContent : 'space-evenly', alignItems : 'stretch'}}>
      ...
      <View style = {{padding : '5%'}}>
        <ClassicForm value = {timeSpent} setValue = {setTimeSpent} placeholder = "Goal (minutes)..." contType = "field" />
        <ClassicForm value = {description} setValue = {setDescription} placeholder = "Color..." contType = "field" />
      </View>
